    ...
    return (
        <div className="bg-purple-400 px-8 py-16 lg:py-24">
            <div className="container mx-auto">
                ...
                <p className="text-lg text-white mb-12">¡Bienvenido a PhilosophIA! Aquí te explicamos cómo trabajamos y qué servicios ofrecemos para que disfrutes al máximo de nuestros amigurumis personalizados.</p>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <ServiceCard
                        icon={<IoCardOutline className="text-white text-4xl" />}
                        title="Método de pago seguro"
                        description="En PhilosophIA, te ofrecemos un método de pago seguro para todas tus compras. Aceptamos todas las principales tarjetas de crédito y débito, así como MercadoPago y transferencias bancarias."
                    />
                    <ServiceCard
                    ...
                    <ServiceCard
                        ...
                        description="En PhilosophIA, nos especializamos en la creación de amigurumis personalizados según tus gustos y preferencias. ¡Cuéntanos tu idea y nosotros la convertiremos en un adorable muñeco de ganchillo!"
                    />
                </div>
            </div>
        </div>
